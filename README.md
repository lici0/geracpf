...
Os dígitos verificadores são calculados através de um algoritmo que soma o produto de cada dígito que compõe o CPF por um peso e calcula o resto da divisão dessa soma por 11. O código fonte deste algorítmo escrito em JavaScript pode ser obtido [aqui](https://github.com/tome-vilela/geracpf/blob/master/jss/all.js)

Neste código fonte são definidas duas funções, uma para gerar um número de CPF e outra para verificá-lo:
